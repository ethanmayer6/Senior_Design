...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_professor_reviews_professor_reviewer",
                        columnNames = {"professor_id", "reviewer_id"})
        },
        indexes = {
                @Index(name = "idx_professor_reviews_professor", columnList = "professor_id"),
                @Index(name = "idx_professor_reviews_reviewer", columnList = "reviewer_id"),
                @Index(name = "idx_professor_reviews_rating", columnList = "rating")
        })
public class ProfessorReview {
    ...
    @Column(name = "class_taken", length = 80)
    private String classTaken;

    @Column(name = "period_taken", length = 120)
