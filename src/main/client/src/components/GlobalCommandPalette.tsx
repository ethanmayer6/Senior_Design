...
const COMMANDS: CommandItem[] = [
  ...
  { id: 'professors', label: 'Professor Reviews', description: 'Browse and rate professors', to: '/professors', shortcut: 'g r' },
  { id: 'course-reviews', label: 'Course Reviews', description: 'Browse and rate courses', to: '/course-reviews', shortcut: 'g v' },
