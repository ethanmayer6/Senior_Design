          ...
          <div className="bg-white shadow-md rounded-lg p-8 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                CourseFlow is a full-stack web application designed to simplify the process of
                planning a path to graduation for students and academic advisors. At Iowa State,
                students and advisors currently verify degree progress by manually comparing PDF
                flowcharts with the classes taken or through Workday’s limited degree progress
                table. This process is slow, prone to error, and stressful for students planning
                their coursework. CourseFlow addresses this problem by providing an interactive
                platform that makes planning, checking, and reviewing degree progress easy and
                engaging.
              </p>
